...
def upgrade() -> None:
    ...
    op.execute("ALTER TEXT SEARCH CONFIGURATION public.zh_cn " "ADD MAPPING FOR n, v, a, i, e, l WITH simple")
    ...
    op.execute(
        "CREATE INDEX idx_chunks_bm25 " "ON rag_chunks " "USING bm25 (chunk_text) " "WITH (text_config='public.zh_cn')"
    )
